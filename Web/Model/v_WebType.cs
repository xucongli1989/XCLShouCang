...
{
    /// <summary>
    /// v_WebType:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class v_WebType
    {
        ...
        private int _isdel;
        private int _ishaschildwebtype;
        private string _fk_username;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public int IsHasChildWebType
        {
            set { _ishaschildwebtype = value; }
            get { return _ishaschildwebtype; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            set { _fk_username = value; }
            get { return _fk_username; }
        }
        #endregion Model
